...
\begin{figure}
    ...
    \caption{The evolution of the colour excess (relative to an unextinguish template from the nearby, normal SN~2011fe) as a function of phase in the $F625W - F814W$ filters for the four images. Each Image's colour curve has been offset by an arbitrary amount for visibility. {\jj I think it is better to offset the points by some delta t or use different markers...}}
